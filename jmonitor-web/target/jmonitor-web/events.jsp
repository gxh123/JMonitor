                            ...
                            <div style="font-size: 15px;margin-bottom: 20px;">
                                <c:forEach items="${ips}" var="ip" varStatus="status">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a style="font-size: 15px;margin-bottom: 20px;color: #717171" href="/events?ip=${ip}"> [${ip}]</a>&nbsp;&nbsp;&nbsp;
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover " >
                                    ...
                                    <tr>
                                        ...
                                        <td>${event.totalCount}</td>
                                        <td>${event.failCount}</td>
                                        <td>${event.failPercent}</td>
