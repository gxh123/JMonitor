                            ...
                            <div style="font-size: 15px;margin-bottom: 20px;">
                                <c:forEach items="${ips}" var="ip" varStatus="status">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a style="font-size: 15px;margin-bottom: 20px;color: #717171" href="/transactions?ip=${ip}"> [${ip}]</a>&nbsp;&nbsp;&nbsp;
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover " >
                                    ...
                                    <tr>
                                        ...
                                        <td>${transaction.totalCount}</td>
                                        <td>${transaction.failCount}</td>
                                        <td>${transaction.failPercent}</td>
                                        <td>${transaction.maxDuration/1000}</td>
                                        <td>${transaction.avgDuration/1000}</td>
